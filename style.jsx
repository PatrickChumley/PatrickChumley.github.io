...
>
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          Here are my ArcGIS StoryMap Projects
        </p>
      </div>
    </div>
    <div
    ...
    >
      ...
      >
        ...
        >
          Description of your third creation
        </p>
      </div>
    </div>
    <div
    ...
    >
      ...
      >
        ...
        >
          Description of your fourth endeavor
        </p>
      </div>
    </div>
  </div>
  ...
  >
    ...
    >
      Geomatics Student - Portland Community College
    </p>
  </div>
  <div
    style={{
  ...
  >
    ...
    >
      <svg
        ...
        style={{ flexGrow: 0, flexShrink: 0, width: 40, height: 40, position: "relative" }}
        preserveAspectRatio="none"
      >
        <path
          d="M20 10.04C14.5 10.04 10 14.53 10 20.06C10 25.06 13.66 29.21 18.44 29.96V22.96H15.9V20.06H18.44V17.85C18.44 15.34 19.93 13.96 22.22 13.96C23.31 13.96 24.45 14.15 24.45 14.15V16.62H23.19C21.95 16.62 21.56 17.39 21.56 18.18V20.06H24.34L23.89 22.96H21.56V29.96C23.9164 29.5878 26.0622 28.3855 27.6099 26.5701C29.1576 24.7546 30.0054 22.4456 30 20.06C30 14.53 25.5 10.04 20 10.04Z"
          fill="#828282"
        />
      </svg>
      <svg
    ...
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      style={{ position: "absolute", left: 79, top: 0 }}
